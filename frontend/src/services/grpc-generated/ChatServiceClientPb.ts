...
import * as proto_chat_pb from './chat_pb_wrapper'; // proto import: "proto/chat.proto"
...
export class ChatServiceClient {
  ...
  methodDescriptorGetMessages = new grpcWeb.MethodDescriptor(
    ...
    proto_chat_pb.GetMessagesResponse,
    (request: proto_chat_pb.GetMessagesRequest) => {
      return request.serializeBinary();
    },
    proto_chat_pb.GetMessagesResponse.deserializeBinary
  );

  getMessages(
    request: proto_chat_pb.GetMessagesRequest,
    metadata?: grpcWeb.Metadata | null): Promise<proto_chat_pb.GetMessagesResponse>;

  getMessages(
    request: proto_chat_pb.GetMessagesRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: proto_chat_pb.GetMessagesResponse) => void): grpcWeb.ClientReadableStream<proto_chat_pb.GetMessagesResponse>;

  getMessages(
    request: proto_chat_pb.GetMessagesRequest,
    metadata?: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: proto_chat_pb.GetMessagesResponse) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/chat.ChatService/GetMessages',
